...
if __name__ == "__main__":
    ...
    # Testing the series
    '''
    If we call this function with no optional parameters (y and z
    are 0 and 1, respectively), the fibonacci series should be produced.
    For example: sum_series(4) should be equal to fibonacci(4)

    If we call the function with optional paramaters (in this case y
    and z are 2 and 1, respectively), the lucas series should be produced.
    For example: sum_series(4,2,1) should be equal to lucas(4)
